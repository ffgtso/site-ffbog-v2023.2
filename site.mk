...
ifeq ($(GLUON_TARGET),ath79-generic)
    ...
    GLUON_netgear-wndr3700_SITE_PACKAGES += $(EXCLUDE_TLS)
    ...
    GLUON_tp-link-tl-wdr3500-v1_SITE_PACKAGES += $(EXCLUDE_TLS)
    GLUON_tp-link-tl-wdr3600-v1_SITE_PACKAGES += $(EXCLUDE_TLS)
    GLUON_tp-link-tl-wdr4300-v1_SITE_PACKAGES += $(EXCLUDE_TLS)
    GLUON_tp-link-tl-wdr1043nd-v2_SITE_PACKAGES += $(EXCLUDE_TLS)
    GLUON_tp-link-tl-wdr1043nd-v3_SITE_PACKAGES += $(EXCLUDE_TLS)
    GLUON_tp-link-tl-wr810n-v1_SITE_PACKAGES += $(EXCLUDE_TLS)
    ...
    GLUON_d-link-dir-505_SITE_PACKAGES += $(EXCLUDE_TLS)
